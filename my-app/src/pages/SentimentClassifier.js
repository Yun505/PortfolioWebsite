    ...
    return (
        <div className="container pl-20 pr-20">
            ...
            <article className="content text-md">
                ...
                <br className="space-y-8"></br>
                <p>
                    A sentiment analysis trading strategy was developed to test the viability of making trades based on data collected from tweets. The project involved gathering and cleaning tweets using <strong>Tweepy</strong> for data collection, <strong>Pandas</strong> for data manipulation, and <strong>NLTK</strong> for text processing. A machine learning model, leveraging <strong>Scikit-learn</strong>, was trained to predict market sentiment from the processed tweet data. This model then made trades based on the sentiment analysis.
                </p>
                <br class="space-y-3"></br>
                <p>
